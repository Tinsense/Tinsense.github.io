...
function render(){
  svg.innerHTML='';const cs=getComputedStyle(document.documentElement),grid=cs.getPropertyValue('--plot-grid').trim(),axis=cs.getPropertyValue('--plot-axis').trim(),label=cs.getPropertyValue('--plot-label').trim(),panel=cs.getPropertyValue('--bg-elevated').trim();const W=720,H=720,ml=70,mr=18,mt=18,mb=64,iw=W-ml-mr,ih=H-mt-mb,max=800;
